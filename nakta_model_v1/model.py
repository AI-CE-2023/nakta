...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, prev_pos, layer_id):
        ...
        xq, xk = self.rotary_emb(xqk, seqlen_offset=prev_pos)
...
class TransformerBlock(nn.Module):
    ...
    def forward(
        ...
        h = x + self.attention.forward(self.attention_norm(x), prev_pos, self.layer_id)
