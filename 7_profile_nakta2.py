...
from nakta_model2 import LLaMA, ModelArgs, Tokenizer, Transformer
...
"""
CUDA_LAUNCH_BLOCKING=1 nsys profile -w true -t cuda,nvtx,osrt,cudnn,cublas --force-overwrite true -o ./model_profile/nakata2_2.nsys-rep torchrun --nproc_per_node 4 7_profile_nakta2.py --ckpt_dir ./weights/modified/30B --tokenizer_path ./weights/original/tokenizer.model  --max_batch_size 64
"""
