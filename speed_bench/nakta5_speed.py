...
from sch.sch_nakta3 import SpeedDataset, collate_fn
from torch.utils.data import DataLoader
from tqdm import tqdm

from nakta_model5 import LLaMA, ModelArgs, Tokenizer, Transformer
from nakta_model5.model import _rebuild_padding
...
def main(
    ...
    for (
        ...
        generator.model.forward(ctx_tokens, (0, 1, 4), -1)
        result = generator.model.forward(
            following_tokens_in, (min_ctx, 1, 4), following_lens
        )
        result = F.log_softmax(result, dim=-1)
        # result = result.cpu()
        following_tokens = _rebuild_padding(following_tokens_in, following_lens)
        result = (
...
"""
torchrun --nproc_per_node 4 nakta5_speed.py
"""
"""
CUDA_LAUNCH_BLOCKING=1 nsys profile -w true -t cuda,nvtx,osrt,cudnn,cublas --force-overwrite true -o ./nakta5_c.nsys-rep torchrun --nproc_per_node 4 nakta5_speed.py
"""
