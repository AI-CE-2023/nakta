...
"""
CUDA_LAUNCH_BLOCKING=1 nsys profile -w true -t cuda,nvtx,osrt,cudnn,cublas --force-overwrite true -o custom_nonparallel.nsys-rep torchrun --nproc_per_node 4 5_profile_custom.py --ckpt_dir ./weights/original/30B_n --tokenizer_path ./weights/original/tokenizer.model  --max_batch_size 64
"""
"""
CUDA_LAUNCH_BLOCKING=1 ncu --target-processes all -o custom_nonparallel.nsight-cuprof-report torchrun --nproc_per_node 4 5_profile_custom.py --ckpt_dir ./weights/original/30B_n --tokenizer_path ./weights/original/tokenizer.model  --max_batch_size 64
"""
